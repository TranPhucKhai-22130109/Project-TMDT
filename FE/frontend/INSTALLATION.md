# blitz_flash_sale-ecommerce-bold - Installation Guide
...
```bash
unzip blitz_flash_sale-ecommerce-bold_nextjs.zip
cd blitz_flash_sale-ecommerce-bold
```
...
```
blitz_flash_sale-ecommerce-bold/
├── public/
├── src/
