...
export default function Page() {
    ...
    // Thêm State để quản lý màn hình Thành Công
    ...
    const handlePlaceOrder = async (e) => {
        ...
        try {
            ...
            if (paymentMethod === "ONLINE" && orderResult.paymentUrl) {
                ...
                // Hiển thị màn hình thành công tại chỗ thay vì nhảy trang
    ...
    // ==========================================
    // UI: MÀN HÌNH ĐẶT HÀNG THÀNH CÔNG (COD)
    // ==========================================
    if (isSuccess) {
        return (
            <div className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
                <Navbar />
                <div className="flex flex-col justify-center items-center px-4 pt-20 pb-12">
                    <div className="max-w-md w-full bg-white dark:bg-gray-800 rounded-2xl shadow-2xl overflow-hidden border border-gray-100 dark:border-gray-700">
                        {/* Header */}
                        <div className="bg-red-600 p-8 flex flex-col items-center justify-center text-white">
                            ...
                            <h2 className="text-2xl font-black mb-2 text-center uppercase tracking-wide">Đặt hàng thành công!</h2>
                            <p className="text-red-100 text-center text-sm">
                                Cảm ơn bạn đã mua sắm. Đơn hàng của bạn đang được chúng tôi xử lý.
                            </p>
                        </div>
                        ...
                        <div className="p-6 space-y-4">
                            <div className="flex justify-between items-center py-3 border-b border-gray-100 dark:border-gray-700">
                                <span className="text-gray-500 dark:text-gray-400 flex items-center gap-2">
                                    <Package className="w-4 h-4" /> Mã đơn hàng
                                </span>
                                <span className="font-semibold text-gray-900 dark:text-white">
                                    #{placedOrder?.id || Math.floor(10000 + Math.random() * 90000)}
                                </span>
                            </div>
                            ...
                            <div className="flex justify-between items-center py-3 border-b border-gray-100 dark:border-gray-700">
                                <span className="text-gray-500 dark:text-gray-400 font-medium">Tổng số tiền</span>
                        ...
                        <div className="p-6 pt-0 flex gap-3 mt-2">
                            <NextLink
                                href="/"
                                className="flex-1 flex justify-center items-center py-3 px-4 rounded-xl border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 font-semibold hover:bg-gray-50 dark:hover:bg-gray-700 transition duration-200"
                            >
                                Trang chủ
                            </NextLink>
                            <NextLink
                                href={`/orders/${placedOrder?.id || ""}`}
                                className="flex-1 flex justify-center items-center py-3 px-4 rounded-xl bg-red-600 text-white font-bold hover:bg-red-700 transition duration-200 shadow-lg shadow-red-600/30"
                            >
                                Xem đơn hàng
                            </NextLink>
                        </div>
