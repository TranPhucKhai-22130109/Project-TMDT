    ...
    <div className="bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-colors duration-300 min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-black tracking-tighter mb-2">Đăng ký tài khoản</h1>
          <p className="text-gray-500 dark:text-gray-400">Tham gia BLITZ để nhận nhiều ưu đãi</p>
        </div>

        {/* Form */}
        <form className="border border-gray-300 rounded-xl dark:border-gray-700 p-8 space-y-6 bg-white dark:bg-gray-800 shadow-sm" onSubmit={handleSubmit}>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input variant="text" className="w-full pl-10 pr-4 py-3 rounded-xl bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 focus:ring-2 focus:ring-red-500 focus:border-transparent outline-none transition-all dark:text-white" type="email" placeholder="you@example.com" id="email" value={email} onChange={(e) => setEmail(e.target.value)} required />
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input variant="text" className="w-full pl-10 pr-4 py-3 rounded-xl bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 focus:ring-2 focus:ring-red-500 focus:border-transparent outline-none transition-all dark:text-white" type="password" placeholder="••••••••" id="password" value={password} onChange={(e) => setPassword(e.target.value)} required minLength={6} />
          ...
          <div className="text-center text-sm text-gray-600 dark:text-gray-400">
            Đã có tài khoản?{' '}
            <NextLink href="/login" className="text-red-600 dark:text-red-500 font-bold hover:underline">
              Đăng nhập ngay
            </NextLink>
          </div>
