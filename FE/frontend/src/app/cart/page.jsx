        ...
        <div className="bg-gray-50 dark:bg-gray-900 min-h-screen text-gray-900 dark:text-gray-100 transition-colors duration-300">
            ...
            <div className="container mx-auto px-4 py-10 max-w-6xl">
                ...
                <div className="flex items-center justify-between mb-8">
                    ...
                    {cart.length > 0 && (
                        <button
                            onClick={() => { if (confirm("Xóa toàn bộ giỏ hàng?")) clearCart(); }}
                ...
                {cart.length === 0 ? (
                    <div className="flex flex-col items-center justify-center py-28 text-center">
                        ...
                        <h2 className="text-2xl font-bold text-gray-400 dark:text-gray-500 mb-3">Giỏ hàng trống</h2>
                        <p className="text-gray-400 dark:text-gray-500 mb-8 max-w-sm">
                            Hãy khám phá các sản phẩm mô hình xe thu nhỏ tuyệt đẹp của chúng tôi!
                        </p>
                        <NextLink
                            href="/products"
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-2 space-y-4">
                            ...
                            {cart.map((item) => (
                                ...
                                >
                                    {/* Image */}
                                    <NextLink href={`/product-detail/${item.id}`} className="flex-shrink-0">
                                    ...
                                    <div className="flex-1 text-center sm:text-left min-w-0">
                                        <NextLink href={`/product-detail/${item.id}`}>
                      ...
                      {shippingFee === 0 ? "Miễn phí 🎉" : formatPrice(shippingFee)}
                                    ...
                                    {shippingFee > 0 && (
                                        <p className="text-xs text-gray-400 bg-gray-50 dark:bg-gray-700 rounded-lg px-3 py-2">
                                            Mua thêm {formatPrice(5_000_000 - cartTotal)} để được miễn phí ship
                                        </p>
                                    )}

                                    <div className="border-t border-gray-100 dark:border-gray-700 pt-3 flex justify-between items-center">
                                        <span className="font-bold text-gray-900 dark:text-white text-base">Tổng cộng</span>
                                        <span className="text-2xl font-black text-red-600">{formatPrice(grandTotal)}</span>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-3 gap-2 pt-2">
                                    {[
                                        ...
                                        <div key={b.label} className="flex flex-col items-center gap-1 text-xs text-gray-400 dark:text-gray-500">
