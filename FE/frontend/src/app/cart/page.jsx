...
import { useCart } from "@/app/cart/CartContext"; // ĐỒNG BỘ: Import hook dùng giỏ hàng
...
export default function Page() {
    const { reloadCartCount } = useCart(); // Lấy hàm đồng bộ số lượng Navbar
    ...
    useEffect(() => {
        const loadCartItems = async () => {
            try {
                // ĐỒNG BỘ GIỎ HÀNG: Ép Navbar cập nhật lại số lượng ngay khi vào trang giỏ hàng
                reloadCartCount();
                ...
                const filtered = list.filter((item) => {
                    ...
                    // Giữ lại sản phẩm hợp lệ và chưa bị xóa mềm
